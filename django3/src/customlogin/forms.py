...
class SignupForm(ModelForm):
    ...
    # 모델클래스 구현에 사용했던 클래스명과 유사하나, 내부기능이 다르기 때문에 주의해야함
    ...
    field_order = ['username', 'password' , 'password_check' , 'Last_name' , 'first_name']
    
    #forms에 들어있는 XXXXInput 객체를 widget으로 지정하면 해당 타입으로 입력양식이 생성됨
    # forms.PasswordInput : 입력한 데이터가 숨겨지도록 비밀번호 처리해주는 위젯
