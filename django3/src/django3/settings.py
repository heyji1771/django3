...
SECRET_KEY = 'm$3^0fyoth*&jcq7l6y2gf8fjb3w@1xlch_z%=jg#h_134zfi0'

# SECURITY WARNING: don't run with debug turned on in production!
# 개발이 끝나면 DEBUG 변수에 False 값을 저장해 에러코드를 숨김
DEBUG = False
# 허용된 도메인주소(127.0.0.1:8000)만 웹서버에 접속할수 있도록 설정하는 변수
# 웹클라이언트는 127.0.0.1이나 XXX(회원이름).pythonanywhere.com으로 시작하는 웹주소만 웹서버에 접속할 수 있음
...
SOCIAL_AUTH_GOOGLE_PLUS_KEY = '1049625091077-prv7qn6lhsjbkcbmjc8qkotm991nu9sj.apps.googleusercontent.com'
SOCIAL_AUTH_GOOGLE_PLUS_SECRET = 'IIe-nU8aNyvYS_3zsgmVAqdX'
...
# MEDIA_URL : 클라이언트가 URL주소로 파일을 요청할 때 사용하는 URL 저장 변수
...
# 웹 서버 프로젝트가 있는 폴더의 files/test/1.jpg 파일을 클라이언트에게 전송함
